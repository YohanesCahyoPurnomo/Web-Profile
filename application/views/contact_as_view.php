        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">If you want to leave a message or suggestions please fill in the form below:</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <!-- <form name="sentMessage" id="contactForm" novalidate> -->
                    <?php echo form_open_multipart('admin/message'); ?>
                        <div class="row">
                            <div class="col-md-6">
